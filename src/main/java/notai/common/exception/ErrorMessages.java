...
public enum ErrorMessages {
    ...
    // document
    DOCUMENT_NOT_FOUND("자료를 찾을 수 없습니다."), INVALID_DOCUMENT_PAGE("존재하지 않는 페이지 입니다."), UNAUTHORIZED_DOCUMENT_ACCESS(
            "자료에 대한 권한이 없습니다."),
    ...
    // external api call
    KAKAO_API_ERROR("카카오 API 호출에 예외가 발생했습니다."), AI_SERVER_ERROR("AI 서버 API 호출에 예외가 발생했습니다."), SLACK_API_ERROR(
            "슬랙 API 호출에 예외가 발생했습니다."),
    ...
    // stt
    STT_TASK_NOT_FOUND("음성 인식 작업을 찾을 수 없습니다."), STT_TASK_ERROR("음성 인식 작업 중에 오류가 발생했습니다."),
    ...
    INVALID_FILE_TYPE("지원하지 않는 파일 형식입니다."), FILE_NOT_FOUND("존재하지 않는 파일입니다."), FILE_SAVE_ERROR(
            "파일을 저장하는 과정에서 오류가 발생했습니다."), INVALID_AUDIO_ENCODING("오디오 파일이 잘못되었습니다."), FILE_READ_ERROR(
            "파일을 읽는 과정에서 오류가 발생했습니다.");
